...
class BaseOptionsMenuBlue extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		descText.setFormat(Paths.font("FZLanTYJ_Cu.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
