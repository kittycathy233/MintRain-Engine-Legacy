...
class BlueBaseOptionsMenu extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		descText.setFormat(Paths.font("cnfont.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
